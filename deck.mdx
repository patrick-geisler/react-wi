...
- debugging hooks
- CHECK CLIENT SPELLING


## Recap:
- Can use hooks multiple times to perform different side effects
- Can sue the same hook multiple times ( just a var in code )
-
## Gotcha
- performance
- testing
- debugging
- Cant use hooks in conditional

## Future
- are classes dead (probably not)
- performance